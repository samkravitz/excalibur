...
namespace Constants
{
    ...
    constexpr u64 pawn_attack_table[2][64] = {
        {
            0x0000000000000200,
            0x0000000000000500,
            0x0000000000000a00,
    ...
    constexpr u64 knight_move_table[64] = {
        0x0000000000020400,
        0x0000000000050800,
        0x00000000000a1100,
        0x0000000000142200,
    ...
    constexpr u64 king_move_table[64] = {
        0x0000000000000302,
        0x0000000000000705,
        0x0000000000000e0a,
        0x0000000000001c14,
    ...
    // bitboard representations of ray attacks for all directions from all squares
    // indexed by NORTH = 0, NORTHEAST = 1, etc.
    // generated by meta/raygen.py
    // see that file for more explanation
    constexpr u64 ray_attack_table[8][64] = {
        {
            // NORTH
            0x0101010101010100,
            0x0202020202020200,
    ...
    // direction lookup table from one square to another
    // example: Direction dir = dir_lookup_table[from_sq][to_sq]
    constexpr Direction dir_lookup_table[64][64] = {
        {
            NORTH,
            EAST,
            EAST,
